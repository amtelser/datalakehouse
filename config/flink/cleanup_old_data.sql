...
SET SESSION nessie.remove_orphan_files_min_retention = '1h';
ALTER TABLE nessie.telematics.gps_reports EXECUTE remove_orphan_files(retention_threshold => '1h');
ALTER TABLE nessie.telematics.gps_reports EXECUTE expire_snapshots(retention_threshold => '1d');